...
struct adt_Api_t {
    ...
    const adt_ContainerApi *ctnr;
    const adt_ListApi *list;
    const adt_SetApi *set;
    const adt_MapApi *map;
    const adt_BagApi *bag;
    const adt_HashableApi *hash;
};
...
struct adt_ContainerApi_t {
    ...
    adt_EEcode (*reserve)(adt_Container *C, va_list sizes);
    adt_EEcode (*resize)(adt_Container *C, va_list sizes);
    ...
    adt_Iterator* (*iterateat)(adt_Container *C, adt_EIteratorMode mode, va_list keys);
};


struct adt_IteratorApi_t {
...
adt_API const adt_Api* adt_getapi(adt_Container* C);
